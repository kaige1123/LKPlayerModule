...
+ (instancetype)loadFromNib {
    ...
    NSArray *views = [[NSBundle bundleWithPath:bundlePath] loadNibNamed:NSStringFromClass([self class]) owner:nil options:nil];
...
- (void)awakeFromNib {
    ...
    NSString *bundlePath = [[NSBundle bundleForClass:[self class]].resourcePath stringByAppendingPathComponent:@"/KKPlayerModule.bundle"];
    _navImageView.image = [UIImage imageNamed:@"Player_Shadow_Top" inBundle:[NSBundle bundleWithPath:bundlePath] compatibleWithTraitCollection:nil];
}
